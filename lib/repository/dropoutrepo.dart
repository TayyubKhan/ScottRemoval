...
class DropOutRepo {
  ...
  Future<bool> DropApi(
      BuildContext context, String dropstatus, String orderId) async {
    SharedPreferences sp = await SharedPreferences.getInstance();
    try {
      var request = http.MultipartRequest(
          'POST',
          Uri.parse(
              'https://scotremovals.com/api/v1/order/update_drop_status'));
      ...
      request.fields['drop_status'] = dropstatus;
