    ...
    return WillPopScope(
      ...
      child: Scaffold(
                                  ...
                                  child: IntrinsicWidth(
                                    child: Container(
                                        ...
                                        child: (urls.isNotEmpty &&
                                            ...
                                            : (index < value.imageFiles.length)
                                                ? Image.file(value.imageFiles[index],
                                                    errorBuilder:
                                                        (context, error, stack) {
                                                    return const Photo_Component();
                                                  })
                            ...
                            builder: (context, value, child) {
                              return Rounded_Button2(
                                ...
                                onPress: () async {
                                  ...
                                  imageFiles2 = [];
                                  for (int i = 0; i < photo.imageFiles.length; i++) {
                                    bool value = await photo.imageFiles[i].exists();
                                    if (value == true) {
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: const Icon(Icons.camera,color: BC.white,),
        ),
      ),
    );
  }
